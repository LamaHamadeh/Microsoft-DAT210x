...
'''
#In this lab, you'll get started with decision trees by revisiting UCI's wheat-seeds dataset, 
#so you can benchmark how long it takes to train and predict with decision trees relative to 
#the speed of KNeighbors and SVC, as well as compare the decision boundary plots produced by it.

#No starter code this time. Instead, take your completed Module6/assignment1.py and modify it
# by adding in a Decision Tree Classifier, setting its max_depth to 9, and random_state=2, but 
#not altering any other setting.
...
X = pd.read_csv('/Users/Admin/Desktop/LAMA/DAT210x/DAT210x-master/Module6/Datasets/wheat.data', index_col = 0)
print (X.head())

#Delete the 'id' column

X = X.reset_index(drop=True) #remove the index column
...
#
# TODO: Copy the labels (wheat_type) out of the dset into variable 'y' then Remove
...
#------------------------------------------------------------------------------
#TODO Create a *Decision Tree Classifier* named DT
#set its max_depth to 9, and random_state=2
#
# .. your code here ..

from sklearn import tree
DT = tree.DecisionTreeClassifier(max_depth=9, random_state=2)
